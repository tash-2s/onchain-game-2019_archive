...
export class UserPlanetsMapUtil {
  ...
  static mapRadiusAndRequiredGold = [
    ...
    [7, 122880000000000],
    [8, 29491200000000000],
    [9, 8257536000000000000],
    [10, 2642411520000000000000],
    [11, 951268147200000000000000],
    [12, 380507258880000000000000000],
    [13, 167423193907200000000000000000],
    [14, 80363133075456000000000000000000],
    [15, 41788829199237120000000000000000000],
    [16, 23401744351572787200000000000000000000],
    [17, 14041046610943672320000000000000000000000]
  ].reverse()
