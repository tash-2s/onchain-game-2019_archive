...
contract TradableAsteriskTokenMetadata is ERC165, ERC721, WhitelistedRole, IERC721Metadata {
  /*
  ...
  string public tokenURIPrefix = "https://example.com/tradable-asterisk-token-jsons/";
...
contract TradableAsteriskTokenBase is
  TradableAsteriskTokenMetadata,
  ERC721Enumerable,
  ERC721Burnable,
  Ownable
{
